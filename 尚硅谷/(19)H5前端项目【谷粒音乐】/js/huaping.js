...
+(function(w){
	w.huaping = {};
	w.huaping.css=function (node,type,val){
	...
	w.huaping.carousel=function (arr){
				//布局
				...
				if(carouselWrap){
					...
					carouselWrap.addEventListener("touchstart",function(ev){
						...
						//index代表ul的位置
						if(needCarousel){
							var index = huaping.css(ulNode,"translateX")/document.documentElement.clientWidth;
							if(-index === 0){
								index = -pointslength;
							}else if(-index ==(arr.length-1)){
								index = -(pointslength-1)
							}
							huaping.css(ulNode,"translateX",index*document.documentElement.clientWidth)
						}
						
						startX=TouchC.clientX;
						//elementX=ulNode.offsetLeft;
						//elementX=translateX;
						elementX=huaping.css(ulNode,"translateX");
					...
					carouselWrap.addEventListener("touchmove",function(ev){
						...
						huaping.css(ulNode,"translateX",elementX+disX);
					})
					carouselWrap.addEventListener("touchend",function(ev){
					    ...
					    index = huaping.css(ulNode,"translateX")/document.documentElement.clientWidth;
